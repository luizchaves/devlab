...
const asset = (id: string, transactions: TransactionFact[], currentPrice: number | null = 40): AssetWithTransactions => ({ id, ticker: id, name: id, category: 'acoes', currency: 'BRL', issuer: null, broker: null, currentPrice, transactions });
