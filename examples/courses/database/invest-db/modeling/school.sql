...
-- #region perfil
-- Entidade Perfil (relacionamento 1:1 com Professor)
CREATE TABLE Perfil (
  id           INTEGER PRIMARY KEY AUTOINCREMENT,
  biografia    TEXT,
...
INSERT INTO Perfil (biografia, lattes, professor_id) VALUES ('Doutora em Computação', 'http://lattes.cnpq.br/123456', 1);
