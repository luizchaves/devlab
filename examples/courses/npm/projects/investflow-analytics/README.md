# InvestFlow — Sprint 6: Analytics e painel admin

Sexta sprint do InvestFlow: a matriz de rentabilidade e a distribuição por classe passam a vir
...
2. **Projeto na Vercel** apontando para este repositório, com **Root Directory** =
   `examples/courses/npm/projects/investflow-analytics` (a Vercel precisa saber que o app vive
...
podem ser conduzidos por prompt: *"crie o projeto InvestFlow na Vercel com root directory
`examples/courses/npm/projects/investflow-analytics`, defina `VITE_SUPABASE_URL` e
