...
| Sprint 2 | Supabase Auth, sessão JWT, proteção de páginas e perfil | 8 | Planejado |
| Sprint 3 | PostgreSQL, migrations, RLS, ativos e transações | 13 | Planejado |
...
| Sprint 8 | Lançamentos editáveis, renda fixa pelo saldo, cotação manual e carteira organizável | 8 | Planejado |
| Sprint 9 | Proventos pela data ex, retorno total e extrato de movimentações | 13 | Planejado |
| Sprint 10 | Moeda por ativo, câmbio, cripto e calendário de mercado | 13 | Planejado |
| Sprint 11 | Perfil com avatar, barra comum, tema, privacidade e deploy | 8 | Planejado |
