...
test.describe
  .serial('Sprint 7: origem e evolucao', () => {
    test('o treemap agrupa por corretora, categoria e emissor sem recarregar (CA07.1, CA07.2)', async ({
      ...
      // Aportes: renda fixa entra no treemap pelo valor atualizado/manual da posição.
      ...
      await expect(page.locator('tr[data-ticker="PETR4"] td').nth(5)).toContainText('R$');
      ...
      await page.click('button[data-dimension="issuer"]');
