...
import eventsRouter from '#routes/events-router.ts';
import docsRouter from '#routes/docs-router.ts';
import healthRouter from '#routes/health-router.ts';
import pingRouter from '#routes/ping-router.ts';
...
// #region static
/**
 * Os arquivos enviados sao servidos por `express.static`, e nao por uma rota
 * que monta o caminho com dado do cliente — que permitiria `../../.env`.
 */
