...
async function update(req: Request<{ id: string }>, res: Response) {
  ...
  // existe (ou nao e do dono) e 404; corpo invalido e 400. Sem ela, o `catch`
  // unico devolveria 400 para os dois casos.
  await Investment.readById(id, req.userId).catch(() => {
    throw new HttpError('Investment not found', 404);
  });
