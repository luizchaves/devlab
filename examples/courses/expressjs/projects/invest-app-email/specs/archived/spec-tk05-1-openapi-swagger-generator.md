...
| ------- | ---- | ---------------- |
| `back/src/docs/openapi.ts` | Criar | Gerador OpenAPI |
...
Cenário: CA05.3 - Sincronia de Documentação
  Dado que um schema Zod é alterado
  Quando o documento OpenAPI é gerado
  Então as mudanças devem ser refletidas automaticamente sem edição manual no Swagger
```
