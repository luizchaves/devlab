# Spec TK06.2: Scripts de Migração e Sementes do Banco Relacional
...
| ------- | ---- | ---------------- |
| `back/src/database/migration.ts` | Criar | Criação de tabelas |
| `back/src/database/seed.ts` | Criar | Inserção de sementes |

## 3. Plano de Implementação por Fases

1. **Fase 1 · Carga do Banco**:
   - Criar tabelas e popular dados iniciais via script db:load.
...
Cenário: CA06.1 - Carga do Banco de Dados
  ...
  Então as tabelas e dados iniciais devem ser criados com sucesso
```
