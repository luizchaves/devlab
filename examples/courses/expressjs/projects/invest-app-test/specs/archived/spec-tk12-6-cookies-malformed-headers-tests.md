...
Criar testes unitários de cookies.test.ts e casos de rejeição de cabeçalhos malformados.

## 2. Arquivos Afetados

| Arquivo | Ação | Responsabilidade |
| ------- | ---- | ---------------- |
| `back/tests/unit/cookies.test.ts` | Criar | Testes unitários de cookies |

## 3. Plano de Implementação por Fases

1. **Fase 1 · Testes de Cookies**:
   - Validar parser de cookies nativo e cabeçalhos de autorização inválidos.
