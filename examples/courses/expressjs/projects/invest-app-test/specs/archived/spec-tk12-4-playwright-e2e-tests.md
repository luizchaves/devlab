...
Criar tests/invest-app.spec.js cobrindo fluxo completo do usuário (cadastro, login, inclusão de investimento e logout).

## 2. Arquivos Afetados

| Arquivo | Ação | Responsabilidade |
| ------- | ---- | ---------------- |
| `tests/invest-app.spec.js` | Criar | Testes E2E com Playwright |

## 3. Plano de Implementação por Fases

1. **Fase 1 · Testes E2E**:
   - Automatizar jornada completa do investidor no navegador.

## 4. Critérios de Aceitação (Gherkin)

```gherkin
Cenário: CA13.3 - Idempotência dos Testes E2E
