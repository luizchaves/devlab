...
## O Princípio da Imutabilidade (Parte 1)
...
## O Princípio da Imutabilidade (Parte 2)
...
## Template Literals (Exemplo de Código) (Parte 1)
...
## Template Literals (Exemplo de Código) (Parte 2)
...
## Métodos de Busca e Inspeção de Texto (Parte 1)
...
## Métodos de Busca e Inspeção de Texto (Parte 2)
...
## Métodos de Fatiamento: `.slice()` e `.substring()` (Parte 1)
...
## Métodos de Fatiamento: `.slice()` e `.substring()` (Parte 2)
...
## Métodos de Transformação: `trim()`, `toUpperCase()`, `repeat()` (Parte 1)
...
## Métodos de Transformação: `trim()`, `toUpperCase()`, `repeat()` (Parte 2)
...
## Preenchimento de Strings: `padStart()` e `padEnd()` (Parte 1)
...
## Preenchimento de Strings: `padStart()` e `padEnd()` (Parte 2)
...
## Conversão String <-> Array: `split()` e `join()` (Parte 1)
...
## Conversão String <-> Array: `split()` e `join()` (Parte 2)
