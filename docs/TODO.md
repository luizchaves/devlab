...
- [ ] **[TASK-015] Análise de Cobertura e Passo a Passo:**
  - [x] `[TASK-015.1]` Analisar etapa a etapa para ver se é possível criar o projeto final seguindo apenas o que está disponível no passo a passo, sem precisar de conhecimento prévio — **não é**: viável até a etapa 6, seis bloqueadores da etapa 7 em diante (ver [spec](../specs/active/spec-002-investapp-monitorapp-coverage.md))
  - [x] `[TASK-015.2]` Percorrer todas as linhas de código para analisar se as tarefas atuais cobrem todas as linhas ou se precisam ser atualizadas — **não cobriam**: das linhas alteradas em cada etapa, o InvestApp exibia 62% e o MonitorApp 82%; depois das correções, 78% e 84% (ver [spec](../specs/active/spec-002-investapp-monitorapp-coverage.md))
  ...
  - [ ] `[TASK-015.4]` Fechar o restante da cobertura planejado na [spec](../specs/active/spec-002-investapp-monitorapp-coverage.md): migrations, `requests.http`, `package.json` e `.env` nas duas trilhas, e as etapas 8 a 11 do MonitorApp
