...
- [ ] **[TASK-016] Estruturação e Documentação dos Projetos:**
  ...
  - [ ] `[TASK-016.11]` InvestFlow React: reconstruir os requisitos RF01–RF22 do InvestFlow vanilla em `examples/courses/react/investflow-react` (Next.js, NextAuth, Prisma, TanStack Query/Table, Zustand, Base UI, CVA, Tailwind CSS v4, Vitest em três camadas e Playwright) e, ao final, a seção Na prática › InvestFlow (React) do guia (spec: `specs/active/spec-015-investflow-react.md`)
