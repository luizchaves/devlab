...
- [ ] **[TASK-016] Estruturação e Documentação dos Projetos:**
  ...
  - [ ] `[TASK-016.10]` Rastreabilidade do InvestFlow para as features de `investflow-origins`: trilha reestruturada em 11 sprints (8. lançamentos e cotação manual, 9. proventos e movimentações, 10. dólar e cripto, 11. perfil e experiência), US17–US32 com critérios numerados por sprint e cada critério coberto por teste (spec: `specs/active/spec-014-investflow-backlog-traceability.md`)
