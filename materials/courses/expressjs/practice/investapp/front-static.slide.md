...
lang: pt-BR
title: "InvestApp: 1. Front-end Estático"
description: "Interface gráfica em HTML e Tailwind CSS servida pelo Express."
---

<!-- _class: lead -->

# InvestApp — 1. Front-end Estático

Interface gráfica em HTML e Tailwind CSS servida pelo Express.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **1. Front-end Estático** na aplicação evolutiva **InvestApp**.
...
- A etapa de **1. Front-end Estático** eleva a maturidade do **InvestApp**.
