...
lang: pt-BR
title: "InvestApp: 12. Testes de Integração"
description: "Suíte de testes de integração automatizados com Vitest."
---

<!-- _class: lead -->

# InvestApp — 12. Testes de Integração

Suíte de testes de integração automatizados com Vitest.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **12. Testes de Integração** na aplicação evolutiva **InvestApp**.
...
- A etapa de **12. Testes de Integração** eleva a maturidade do **InvestApp**.
