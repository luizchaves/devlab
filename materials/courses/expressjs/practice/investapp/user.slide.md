...
lang: pt-BR
title: "InvestApp: 7. Entidade Usuário"
description: "Criação do modelo de Usuário e associação de carteira 1:N."
---

<!-- _class: lead -->

# InvestApp — 7. Entidade Usuário

Criação do modelo de Usuário e associação de carteira 1:N.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **7. Entidade Usuário** na aplicação evolutiva **InvestApp**.
...
- A etapa de **7. Entidade Usuário** eleva a maturidade do **InvestApp**.
