...
lang: pt-BR
title: "InvestApp: 11. Documentação Swagger"
description: "Documentação viva e interativa da API com OpenAPI 3.0."
---

<!-- _class: lead -->

# InvestApp — 11. Documentação Swagger

Documentação viva e interativa da API com OpenAPI 3.0.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **11. Documentação Swagger** na aplicação evolutiva **InvestApp**.
...
- A etapa de **11. Documentação Swagger** eleva a maturidade do **InvestApp**.
