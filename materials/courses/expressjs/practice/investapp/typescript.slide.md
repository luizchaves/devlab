...
lang: pt-BR
title: "InvestApp: 3. Migração TypeScript"
description: "Refatoração para TypeScript estrito e estrutura em camadas."
---

<!-- _class: lead -->

# InvestApp — 3. Migração TypeScript

Refatoração para TypeScript estrito e estrutura em camadas.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **3. Migração TypeScript** na aplicação evolutiva **InvestApp**.
...
- A etapa de **3. Migração TypeScript** eleva a maturidade do **InvestApp**.
