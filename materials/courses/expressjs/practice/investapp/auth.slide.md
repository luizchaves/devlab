...
lang: pt-BR
title: "InvestApp: 8. Autenticação JWT"
description: "Cadastro de usuários, hash de senha seguro e autenticação por JWT."
---

<!-- _class: lead -->

# InvestApp — 8. Autenticação JWT

Cadastro de usuários, hash de senha seguro e autenticação por JWT.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **8. Autenticação JWT** na aplicação evolutiva **InvestApp**.
...
- A etapa de **8. Autenticação JWT** eleva a maturidade do **InvestApp**.
