...
lang: pt-BR
title: "InvestApp: 2. API em Memória"
description: "Primeiros endpoints RESTful de CRUD com armazenamento temporário em array."
---

<!-- _class: lead -->

# InvestApp — 2. API em Memória

Primeiros endpoints RESTful de CRUD com armazenamento temporário em array.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **2. API em Memória** na aplicação evolutiva **InvestApp**.
...
- A etapa de **2. API em Memória** eleva a maturidade do **InvestApp**.
