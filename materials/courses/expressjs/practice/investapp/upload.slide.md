...
lang: pt-BR
title: "InvestApp: 9. Upload de Arquivos"
description: "Processamento e armazenamento de avatar do usuário com Multer."
---

<!-- _class: lead -->

# InvestApp — 9. Upload de Arquivos

Processamento e armazenamento de avatar do usuário com Multer.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **9. Upload de Arquivos** na aplicação evolutiva **InvestApp**.
...
- A etapa de **9. Upload de Arquivos** eleva a maturidade do **InvestApp**.
