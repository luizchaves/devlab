...
lang: pt-BR
title: "InvestApp: 13. Conteinerização Docker"
description: "Empacotamento da aplicação e banco com Docker Compose."
---

<!-- _class: lead -->

# InvestApp — 13. Conteinerização Docker

Empacotamento da aplicação e banco com Docker Compose.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **13. Conteinerização Docker** na aplicação evolutiva **InvestApp**.
...
- A etapa de **13. Conteinerização Docker** eleva a maturidade do **InvestApp**.
