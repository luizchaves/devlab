...
lang: pt-BR
title: "InvestApp: 5. Persistência SQLite"
description: "Armazenamento persistente de investimentos em banco SQL nativo."
---

<!-- _class: lead -->

# InvestApp — 5. Persistência SQLite

Armazenamento persistente de investimentos em banco SQL nativo.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **5. Persistência SQLite** na aplicação evolutiva **InvestApp**.
...
- A etapa de **5. Persistência SQLite** eleva a maturidade do **InvestApp**.
