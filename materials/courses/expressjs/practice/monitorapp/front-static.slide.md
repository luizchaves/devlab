...
lang: pt-BR
title: "MonitorApp: 1. Front-end Estático"
description: "Painel estático de monitoramento em HTML/CSS."
---

<!-- _class: lead -->

# MonitorApp — 1. Front-end Estático

Painel estático de monitoramento em HTML/CSS.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **1. Front-end Estático** na aplicação evolutiva **MonitorApp**.
...
- A etapa de **1. Front-end Estático** eleva a maturidade do **MonitorApp**.
