...
lang: pt-BR
title: "MonitorApp: 9. Chamadas de Sistema"
description: "Execução de pings nativos via chamadas de sistema no Node.js."
---

<!-- _class: lead -->

# MonitorApp — 9. Chamadas de Sistema

Execução de pings nativos via chamadas de sistema no Node.js.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **9. Chamadas de Sistema** na aplicação evolutiva **MonitorApp**.
...
- A etapa de **9. Chamadas de Sistema** eleva a maturidade do **MonitorApp**.
