...
lang: pt-BR
title: "MonitorApp: 10. Métricas em Tempo Real"
description: "Notificação em tempo real de status com WebSockets."
---

<!-- _class: lead -->

# MonitorApp — 10. Métricas em Tempo Real

Notificação em tempo real de status com WebSockets.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **10. Métricas em Tempo Real** na aplicação evolutiva **MonitorApp**.
...
- A etapa de **10. Métricas em Tempo Real** eleva a maturidade do **MonitorApp**.
