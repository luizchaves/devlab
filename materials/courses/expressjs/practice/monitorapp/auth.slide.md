...
lang: pt-BR
title: "MonitorApp: 8. Autenticação RBAC"
description: "Controle de acesso baseado em papéis com JWT."
---

<!-- _class: lead -->

# MonitorApp — 8. Autenticação RBAC

Controle de acesso baseado em papéis com JWT.

---

## Visão Geral & Objetivos

- **Escopo**: Implementar **8. Autenticação RBAC** na aplicação evolutiva **MonitorApp**.
...
- A etapa de **8. Autenticação RBAC** eleva a maturidade do **MonitorApp**.
