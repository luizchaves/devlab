...
<SourceCode path="examples/lp2/codes/expressjs/invest-app-upload/prisma/schema.prisma" mark="40" />

```bash
$ npx prisma migrate dev --name user_image
```

<SourceCode path="examples/lp2/codes/expressjs/invest-app-upload/src/models/Image.js" />

<SourceCode path="examples/lp2/codes/expressjs/invest-app-upload/src/models/User.js" mark="23-30,45-51" />
...
<SourceCode path="examples/lp2/codes/expressjs/invest-app-upload/src/config/multer.js" />
...
<SourceCode path="examples/lp2/codes/expressjs/invest-app-upload/src/index.js" mark="24" />
...
<SourceCode path="examples/lp2/codes/expressjs/invest-app-upload/public/profile.html" />

<SourceCode path="examples/lp2/codes/expressjs/invest-app-upload/public/js/profile.js" />

<SourceCode path="examples/lp2/codes/expressjs/invest-app-upload/public/js/services/api.js" />
