...
description: "Cloud Firestore - material da disciplina Programação para Web 2."
course: packages
sidebar:
...
```ini title="codes/package/firebase-firestore/invest-app/.env.example"
VITE_APP_APIKEY=
VITE_APP_AUTHDOAMIN=
VITE_APP_PROJECTID=
...
<SourceCode path="examples/packages/baas/firebase-firestore/invest-app/js/services/api.js" />
