...
<HtmlPreview path="examples/web-api/pw2/browser-web-apis/dragdrop.html" height="26rem" label="dragdrop.html" allowScripts serveFromPublic />

<SourceCode path="examples/web-api/pw2/browser-web-apis/dragdrop.html" />
