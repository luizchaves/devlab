...
<HtmlPreview path="examples/web-api/pw2/browser-web-apis/fullscreen.html" height="20rem" label="fullscreen.html" allowScripts serveFromPublic />

<SourceCode path="examples/web-api/pw2/browser-web-apis/fullscreen.html" />
