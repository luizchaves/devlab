...
description: "Window, location, history, console, document e outras Web APIs disponíveis no navegador."
course: web-api
sidebar:
...
<SourceCode path="examples/web-api/browser-objects/hello-js/index.html" lang="html" />

<SourceCode path="examples/web-api/browser-objects/hello-js/js/index.js" lang="js" />
...
<SourceCode path="examples/web-api/pw2/browser-objects/hello-js/index.html" lang="html" />

<SourceCode path="examples/web-api/pw2/browser-objects/hello-js/js/index.js" lang="js" />
...
```html
<button onclick="confirm('Is this JavaScript?')">Confirm</button>
```
