...
<ProjectLinks path="examples/express/projects/hello" devcontainer="express-hello" />
...
<CodeTabs
  ...
  files={[
    { path: 'examples/express/projects/hello/src/server.js', title: 'src/server.js', showLineNumbers: true },
    { path: 'examples/express/projects/hello/package.json', title: 'package.json' },
  ]}
/>
