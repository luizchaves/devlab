...
<CodeTabs
  syncKey="express-mvc"
  files={[
    { path: 'examples/express/projects/mvc/src/app.js', title: 'src/app.js', showLineNumbers: true },
    { path: 'examples/express/projects/mvc/src/routes/user-router.js', title: 'src/routes/user-router.js', showLineNumbers: true },
    { path: 'examples/express/projects/mvc/src/controllers/user-controller.js', title: 'src/controllers/user-controller.js', showLineNumbers: true },
    { path: 'examples/express/projects/mvc/src/models/user-model.js', title: 'src/models/user-model.js', showLineNumbers: true },
    { path: 'examples/express/projects/mvc/src/middlewares/error-handler.js', title: 'src/middlewares/error-handler.js', showLineNumbers: true },
  ]}
/>
