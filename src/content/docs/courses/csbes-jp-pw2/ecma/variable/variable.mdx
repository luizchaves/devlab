---
title: "Variáveis"
description: "Variáveis - material da disciplina Programação para Web 2."
course: csbes-jp-pw2
sidebar:
  label: "Variáveis"
  order: 3
...
| Primitive | [String](../../string/string/) | `'Hello'`, `"Hello"`, `` `Hello` ``                                                           |
| Object    | [Array](../../array/array/)   | `[]`<br />`[1, 2, 3]`<br />`[1, '2', true, [3, false]]`<br />`["Alice", "alice@email"]`       |
| Object    | [Object](../../object/object/) | `{name: "Alice", email: "alice@email"}`                                                       |
