...
description: "Objetos do Navegador - material da disciplina Programação para Web 2."
course: csbes-jp-pw2
sidebar:
...
<SourceCode path="examples/pw2/codes/w3c/browser-objects/hello-js/index.html" lang="html" />

<SourceCode path="examples/pw2/codes/w3c/browser-objects/hello-js/js/index.js" lang="js" />
