...
description: "Tipos de dados, var, let, const, escopo e tipagem dinâmica em JavaScript."
course: cstrc-jp-dw
sidebar:
  label: "Variáveis"
  order: 6
...
| Primitive | Number    | `-15`<br />`15`, `0b1111`, `0o17`, `0xf`<br />`-123.45`<br />`123.45`, `1.2345e2`, `12345E-2` |
