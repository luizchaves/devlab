...
Esta aula apresenta as estruturas de dados **Map** e **Set** (introduzidas no ES6) e suas variações fracas **WeakMap** e **WeakSet**: como armazenar mapeamentos complexos de chave-valor, garantir a unicidade de elementos, iterar sobre coleções e evitar vazamentos de memória.
...
Com o domínio sobre coleções estruturadas como `Map` e `Set`, o próximo passo é aprender a agrupar dados e comportamentos em estruturas de chave-valor.
