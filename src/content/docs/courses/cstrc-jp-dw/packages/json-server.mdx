...
<SourceCode path="examples/dw/codes/package/json-server/db.json" />
...
<SourceCode path="examples/dw/codes/package/json-server/package.json" />

<SourceCode path="examples/dw/codes/package/json-server/src/server.js" />
