...
<CodeTabs
  syncKey="express-mvc"
  files={[
    { path: 'examples/express-mvc/src/app.js', title: 'src/app.js', showLineNumbers: true },
    { path: 'examples/express-mvc/src/routes/user-router.js', title: 'src/routes/user-router.js', showLineNumbers: true },
    { path: 'examples/express-mvc/src/controllers/user-controller.js', title: 'src/controllers/user-controller.js', showLineNumbers: true },
    { path: 'examples/express-mvc/src/models/user-model.js', title: 'src/models/user-model.js', showLineNumbers: true },
    { path: 'examples/express-mvc/src/middlewares/error-handler.js', title: 'src/middlewares/error-handler.js', showLineNumbers: true },
  ]}
/>
...
<Aside type="tip">
  A aula correspondente é [Express.js → MVC](../../express/mvc/).
</Aside>
