...
description: "ReactJS - material da disciplina Programação para Web 2."
course: react
sidebar:
  label: "Introdução"
---
...
Este tópico monta o primeiro projeto React e apresenta componentes, JSX e props. Ao
responder "Yes" para TypeScript na criação do projeto, vale acompanhar em paralelo
[TypeScript no React](../../../typescript/practice/react/), que trata de como tipar props,
hooks, eventos e contexto.
...
![Mapeamento de componentes ReactJS para elementos DOM da Web](/src/assets/images/courses/react/introduction/components-reactjs.png)
...
- Desktop: [react-native-windows](https://github.com/microsoft/react-native-windows), [react-native-macOS](https://github.com/microsoft/react-native-macos) (React Native)
- VR: [react-360](https://facebook.github.io/react-360/) (React Native)
- Terminal: [ink](https://github.com/vadimdemedes/ink) (ReactJS)
- PDF: [react-pdf](https://github.com/diegomura/react-pdf) (ReactJS)
- Email: [react-email](https://github.com/resendlabs/react-email) (ReactJS)
- TV: [react-native-tvos](https://github.com/react-native-tvos) (React Native)
- [Outras](https://reactnative.dev/docs/out-of-tree-platforms)

![Mapeamento de componentes React Native para elementos nativos Mobile](/src/assets/images/courses/react/introduction/components-react-native.png)
...
![Diagrama do Next.js mapeando segmentos de rotas da aplicação para segmentos de URL](https://nextjs.org/_next/image?url=%2Fdocs%2Flight%2Froute-segments-to-path-segments.png&w=3840&q=75&dpl=dpl_Cwk9nEfGMCGXVNS2aBtf8GtguTZw)

Fonte: [Next.js Docs - Routing Fundamentals - Route Segments](https://nextjs.org/docs/app/building-your-application/routing)

![Estrutura de diretórios para definição de rotas no Next.js App Router](https://nextjs.org/_next/image?url=%2Fdocs%2Flight%2Fdefining-routes.png&w=3840&q=75&dpl=dpl_Cwk9nEfGMCGXVNS2aBtf8GtguTZw)
...
<PackageManagerTabs package="@iconify/react" dev />
