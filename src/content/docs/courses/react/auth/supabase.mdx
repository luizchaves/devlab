...
<SourceCode path="examples/react/supabase-auth/invest-app/src/services/supabase.js" />

<SourceCode path="examples/react/supabase-auth/invest-app/src/contexts/UserAuthContext.jsx" />

<SourceCode path="examples/react/supabase-auth/invest-app/src/components/ProtectedPage.jsx" />

<SourceCode path="examples/react/supabase-auth/invest-app/src/components/NavBar.jsx" />

<SourceCode path="examples/react/supabase-auth/invest-app/src/app/signup/page.jsx" />

<SourceCode path="examples/react/supabase-auth/invest-app/src/app/signin/page.jsx" />
